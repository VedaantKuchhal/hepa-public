...
This file is used to sanity check data produced from `CM_modpm_cleaning`. Time-series plots are created of each sensor and given a quick visual check. If required, appropriate edits are to be made to `CM_modpm_cleaning`.
...
Participant IDs
```{r}
# Get relevant participant IDs from CM_participants
