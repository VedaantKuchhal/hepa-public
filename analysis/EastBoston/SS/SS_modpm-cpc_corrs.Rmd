...
*This file loads the dataframe created from running `SS_modpm-cpc_cleaning`. Make sure you run that file first (if you haven't already) before running this file.*
...
Results can be found in `summary/EastBoston/SS/s_SS_MC_corr.csv`.
...
write.csv(corr_df, "summary/EastBoston/SS/s_SS_MC_corr.csv")
```
