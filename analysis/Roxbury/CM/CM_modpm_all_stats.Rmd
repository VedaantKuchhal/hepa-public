# Roxbury Data Summarization - multiple (for Mod-PM)

## STOP

**HAVE YOU RUN `CM_modpm_cleaning`?**
*This file loads a dataframe created from running `CM_modpm_cleaning`. Make sure you run that file first (if you haven't already) before running this file.*

This script is used to calculated summary statistics for multiple participants in the Roxbury pilot, for Mod-PM deployments by Olin.

Results can be found in `summary/Roxbury/CM/s_CM_M_quants.csv`.
...
write.csv(summary_normal, "summary/Roxbury/CM/s_CM_M_quants.csv")
```
