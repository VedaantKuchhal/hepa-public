# Revere Correlation Calculations

## STOP

**HAVE YOU RUN `RH_modpm-cpc_cleaning`?**
*This file loads the dataframe created from running `RH_modpm-cpc_cleaning`. Make sure you run that file first (if you haven't already) before running this file.*
...
Results can be found in `summary/Revere/RH/s_RH_MC_corr.csv`.
...
write.csv(corr_df, "summary/Revere/RH/s_RH_MC_corr.csv")
```
